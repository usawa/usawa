...
(function(window, document, undefined) {
    ...
    var defaults = {
        messages: {
            ...
            valid_ip: 'The %s field must contain a valid IP (v4 or v6).',
            valid_ipv4: 'The %s field must contain a valid IPv4.',
    ...
    var ruleRegex = /^(.+?)\[(.+)\]$/,
        ...
        ipv4Regex = /^((25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})\.){3}(25[0-5]|2[0-4][0-9]|1[0-9]{2}|[0-9]{1,2})$/i,
    ...
    FormValidator.prototype._hooks = {
        ...
        valid_ip: function(field) {
            return (ipv4Regex.test(field.value) || ipv6Regex.test(field.value) );
        },

        valid_ipv4: function(field) {
            return (ipv4Regex.test(field.value));
        },
        
        valid_ipv6: function(field) {
            return (ipv6Regex.test(field.value));
        },
